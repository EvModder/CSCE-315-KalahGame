...
public class Board {
	...
	public final int numHouses, kalah2, house02, seedsToWin;
...
//		housesAndKalahs[kalah2] = 0;
	...
	public Board(int numHouses, int seedsToWin, int[] squares){
		this.numHouses = numHouses;
...
//		return new Board(numHouses, squares);
		return new Board(numHouses, seedsToWin, Arrays.copyOf(housesAndKalahs, housesAndKalahs.length));
	}
	...
	public boolean gameOver(){
		if(housesAndKalahs[numHouses] > seedsToWin || housesAndKalahs[kalah2] > seedsToWin){
			return true;
		}
