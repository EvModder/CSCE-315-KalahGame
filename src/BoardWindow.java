...
public class BoardWindow extends JFrame{
	...
	HouseButton[] boardSquares;

	BoardWindow(GUIManager guiHandler, int[] board){
		...
		for(int i=0; i<kalah1; ++i){
			player1Houses.add(boardSquares[i] = new HouseButton(guiHandler, i, board[i]));
		}
		for(int i=kalah2-1; i>kalah1; --i){
			player2Houses.add(boardSquares[i] = new HouseButton(guiHandler, i, board[i]));
		}
		//add kalahs
		boardSquares[kalah1] = new HouseButton(guiHandler, kalah1, board[kalah1]);
		boardSquares[kalah2] = new HouseButton(guiHandler, kalah2, board[kalah2]);
