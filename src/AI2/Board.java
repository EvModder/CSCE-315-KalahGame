public class Board{
	...
	public Board(Board inputBoard){
		this.initHouses = inputBoard.initHouses;
		this.initSeeds = inputBoard.initSeeds;
		this.kalahPlayer1 = inputBoard.kalahPlayer1;
		this.kalahPlayer2 = inputBoard.kalahPlayer2;
		this.numHousesAndKalahs = inputBoard.numHousesAndKalahs;
		this.player1Turn = inputBoard.player1Turn;
		this.hasUsedPieRule = inputBoard.hasUsedPieRule;
		this.numSwitches = inputBoard.numSwitches;
		this.initRandomSeeds = inputBoard.initRandomSeeds;
		this.random = inputBoard.random;
		
		this.positions = new int[numHousesAndKalahs];
		for (int i=0; i<numHousesAndKalahs; i++){
			positions[i] = inputBoard.positions[i];
		}
	}
	...
	public int getNumHousesAndKalahs(){
		return numHousesAndKalahs;
	}
